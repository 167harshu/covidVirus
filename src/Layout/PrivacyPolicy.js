...
const PrivacyPolicy = () => {
    return (
        <div>
            {/* Banner */}
            <section id="banner">
                <h1 style={{fontWeight: 525}}>Privacy Policy</h1>
...
<section>
  <div className="inner"><br /><br />
    ...
    <p>G31/ e-DAC built the Curb The Virus app as a free app. This SERVICE is provided by G31/ e-DAC at no cost and is intended
      for use as is.<br />
      This page is used to inform website visitors regarding our policies with the collection, use, and
      disclosure of Personal Information if anyone decided to use our Service.<br />
      If you choose to use our Service, then you agree to the collection and use of information in
      relation with this policy. The Personal Information that we collect are used for providing and
      improving the Service. We will not use or share your information with anyone except as described
      in this Privacy Policy.<br />
      The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
      which is accessible at Curb The Virus app, unless otherwise defined in this Privacy Policy.</p>
    <h2 style={{fontWeight: 'bold'}}>1. Information Collection and Use</h2>
    ...
    </p><h2 style={{fontWeight: 'bold'}}>2. Log Data</h2>
    ...
    <h2 style={{fontWeight: 'bold'}}>3. Cookies</h2>
    ...
    <p>This Services does not uses these “cookies” explicitly. However, the app may use third party code
      ...
      this Service.</p>
    <h2 style={{fontWeight: 'bold'}}>4. Service Providers</h2>
    ...
    <h2 style={{fontWeight: 'bold'}}>5. Security</h2>
    <p>We value your trust in providing us your Personal Information, thus we are striving to use
      commercially acceptable means of protecting it. But remember that no method of transmission over
      the internet, or method of electronic storage is 100% secure and reliable, and we cannot
      guarantee its absolute security.</p>
    <h2 style={{fontWeight: 'bold'}}>6. Links to Other Sites</h2>
    <p>This Service may contain links to other sites. If you click on a third-party link, you will be
      ...
      sites or services.</p>
    <h2 style={{fontWeight: 'bold'}}>7. Children’s Privacy</h2>
    ...
    <h2 style={{fontWeight: 'bold'}}>8. Changes to This Privacy Policy</h2>
